...
export class Backend implements backendInterface {
    ...
    async addCropPrice(arg0: CropPrice): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCropPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addFertilizerSchedule(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFertilizerSchedule(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addWeatherForecast(arg0: WeatherForecast): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addWeatherForecast(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPrices(): Promise<Array<CropPrice>> {
        if (this.processError) {
            try {
    ...
    async getArticlesByLanguage(arg0: string): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getArticlesByLanguage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMySchedule(): Promise<FertilizerSchedule> {
        if (this.processError) {
            try {
                const result = await this.actor.getMySchedule();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPricesByCrop(arg0: string): Promise<Array<CropPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPricesByCrop(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWeatherByRegion(arg0: string): Promise<WeatherForecast> {
        if (this.processError) {
            try {
                const result = await this.actor.getWeatherByRegion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeKnowledgeData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeKnowledgeData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeMarketData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeMarketData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeWeatherData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeWeatherData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
